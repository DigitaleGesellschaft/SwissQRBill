...
class PDF extends extended_pdf_1.default.PDF {
    constructor(data, options) {
        ...
        this.size = "A6/5";
        this._scissors = true;
        this._enforceHorizontalLine = false;
        this._language = "DE";
        this._marginTop = 0;
        ...
        if (options !== undefined) {
            ...
            if (options.enforceHorizontalLine !== undefined) {
                this._enforceHorizontalLine = options.enforceHorizontalLine;
            }
        }
    ...
    addPage(options) {
        if (options === undefined) {
            const height = this._enforceHorizontalLine
                ? this._scissors ? 107 : 105.5
                : 105;
            options = {
                margin: utils.mmToPoints(5),
                layout: this.size === "A4" ? "portrait" : "landscape",
                size: this.size === "A4" ? this.size : [utils.mmToPoints(height), utils.mmToPoints(210)]
            };
        }
    ...
    addQRBill() {
        ...
        this._marginTop = this._enforceHorizontalLine === 'bottom'
            ? 0
            : this.page.height - utils.mmToPoints(105);
        this._drawOutlines();
        this._drawReceipt();
    ...
    _drawOutlines() {
        ...
        if (this.page.height > utils.mmToPoints(105)) {
            if (!this._enforceHorizontalLine || this._enforceHorizontalLine === 'top') {
            ...
            else if (this._enforceHorizontalLine === 'bottom') {
                this.moveTo(0, utils.mmToPoints(105))
                    .lineTo(utils.mmToPoints(210), utils.mmToPoints(105))
                    .lineWidth(.75)
                    .strokeOpacity(1)
                    .dash(1, { size: 1 })
                    .strokeColor("black")
        ...
        if (this._scissors === true) {
            ...
            if (this.page.height > utils.mmToPoints(105)) {
                if (!this._enforceHorizontalLine || this._enforceHorizontalLine === 'top') {
                    ...
                    this.addPath(scissorsTop, utils.mmToPoints(105), utils.mmToPoints(105))
                        .fillColor("black")
                        .fill();
                }
            }
    ...
    _validateData() {
        //-- Creditor
        if (this._data.creditor === undefined) {
        ...
        if (typeof this._data.creditor.name !== "string") {
        ...
        if (typeof this._data.creditor.address !== "string") {
        ...
        if (this._data.creditor.houseNumber !== undefined) {
            ...
            if (this._data.creditor.houseNumber.toString().length > 16) {
        ...
        if (typeof this._data.creditor.zip !== "number") {
        ...
        if (typeof this._data.creditor.city !== "string") {
        ...
        if (typeof this._data.creditor.country !== "string") {
        ...
        if (typeof this._data.currency !== "string") {
            throw new Error("Currency must be a string.");
        }
        if (this._data.currency.length !== 3) {
            throw new Error("Currency must be a length of 3 characters.");
        }
        if (this._data.currency !== "CHF" && this._data.currency !== "EUR") {
        ...
        //-- Reference
        if (this._data.reference !== undefined) {
            if (typeof this._data.reference !== "string") {
                throw new Error("Reference name must be a string.");
            }
            if (this._data.reference.length > 27) {
        ...
        if (this._data.additionalInformation !== undefined) {
            ...
            if (typeof this._data.additionalInformation !== "string") {
        ...
        if (this._data.av1 !== undefined) {
            ...
            if (typeof this._data.av1 !== "string") {
        ...
        if (this._data.av2 !== undefined) {
            ...
            if (typeof this._data.av2 !== "string") {
    ...
    _generateQRCode() {
        ...
        qrString += "\n1";
        //-- IBAN
        qrString += (_a = "\n" + this._data.creditor.account) !== null && _a !== void 0 ? _a : "\n";
        //-- Creditor
        if (this._data.creditor.houseNumber !== undefined) {
            // Address Type
            qrString += "\nS";
